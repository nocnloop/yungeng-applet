 ...
 * @Date: 2022-05-05 10:56:38
 * @LastEditors: Qiuxue.Wu - LCFC
 * @LastEditTime: 2022-05-12 11:18:30
 * @Description: file content
 * @FilePath: /smart-logistics-applet/pages/release-history/components/ApplyInList.vue
-->
<template>
  <view v-show="i === index">
      ...
      <view class="goods-list">
        <view class="goods-item" v-for="item in list" :key="item.id" @click="onViewDetail(item)">
          ...
          <view class="item-bottom">
            <text class="left">审核结果：{{ approvedResultText(item) }}</text>
          </view>
          <view class="item-bottom">
